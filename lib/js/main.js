  ...
  if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
    ...
    $("[data-fancybox]").fancybox({
        ...
        var callScreenResizeRight = (function callScreenResizeRight(){
            var timeTravel = $('.timeTravel').width();
            if (timeTravel == '667'){
                $('#countDown').addClass('xtra');
            } else if(timeTravel == '736'){
                $('#countDown').addClass('xtra736');
            } 
            else{
                $('#countDown').removeClass('xtra');
                $('#countDown').removeClass('xtra736');
            }
